...
| `TestGroupSortControl_ColonMethodDirectionChange_PreservesMethodAndUpdatesDesc`      | Direction parsing truncates or replaces a method ID containing `:`         | Adversarial regression for the removed `${method.id}:...` encoding                                                            |
