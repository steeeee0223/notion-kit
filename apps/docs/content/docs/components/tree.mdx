...
<Installation packages="@notion-kit/ui" registryName="tree-default" />
...
import { TreeList } from "@notion-kit/ui/tree/presets";
...
A searchable tree interface using a combobox.

<ComponentPreview
  name="tree-combobox"
  preview={`<ComboboxTree tree={tree} />`}
/>
...
Pre-styled tree list component from `@notion-kit/ui/tree/presets`.
...
Searchable tree component with combobox behavior.
