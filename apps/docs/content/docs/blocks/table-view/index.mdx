...
<ComponentPreview name="table-view-calendar" hideCode />
...
Calendar creates an empty Date property when none is available. Timeline
retains its metadata initialization behavior. Locked tables allow navigation
and opening rows but prevent date edits and creation.
