...
| `transferConfig`      | `(column: Column<TPlugin>, data: Row[]) => string`    | Converts the given column and rows data to this plugin configuration. This is useful for changing column types.        |
