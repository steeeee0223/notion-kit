...
const SearchIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 16 16"
      key="search"
      className="fill-primary/45 block size-3.5 shrink-0 grow-0"
    >
...
const ClearIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 16 16"
      key="clearInput"
      className="fill-primary/35 hover:bg-primary/5 dark:fill-primary/30 block size-4 shrink-0"
    >
...
const Input = ({
  ...
  return (
    <div className={cn(inputVariants({ variant, className }))}>
      ...
      <input
        className="placeholder:text-primary/45 block resize-none border-none outline-hidden file:bg-inherit file:font-medium disabled:cursor-not-allowed disabled:opacity-50 [&::-webkit-search-cancel-button]:appearance-none"
        {...props}
      />
