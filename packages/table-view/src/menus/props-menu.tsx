        ...
        {deletedCount > 0 && (
          ...
          >
            <MenuItemAction className="flex items-center fill-default/35 text-muted">
              ...
              <Icon.ChevronRight className="transition-out ml-1.5 block h-full w-3 shrink-0 fill-default/35 dark:fill-default/30" />
            </MenuItemAction>
          </MenuItem>
        )}
      </MenuGroup>
  ...
  return (
    ...
    >
      <MenuItemAction className="flex items-center fill-default/35 text-muted">
        ...
        >
          {hidden ? (
            <Icon.EyeHide className="size-4 fill-icon" />
          ) : (
            <Icon.Eye className="size-4 fill-icon" />
          )}
        </Button>
        <Icon.ChevronRight className="transition-out ml-1.5 block h-full w-3 shrink-0 fill-default/35 dark:fill-default/30" />
      </MenuItemAction>
